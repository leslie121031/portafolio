<template>
  <section class="about">
    ...
    <div class="about-text">
      <h1>ABOUT ME</h1>
      <p>
        Soy Leslie Sofía Arteta Coronell, diseñadora gráfica digital y creadora de contenido digital.
        <br><br>
...
.about {
  ...
  margin: auto;
  padding: 60px 20px;
  flex-wrap: wrap; /* Esto es para que se adapte en pantallas pequeñas */
}
